...
docker run -p localhost:8888:8080 -e TZ="America/New_York" -e DEFAULT_DOMAIN=<DOMAIN> -e IS_HTTPS_ENABLED=true -e GEOLITE_LICENSE_KEY=<GEOLITE_LICENSE_KEY> -e DB_DRIVER=maria -e DB_USER=shlink -e DB_NAME=shlink -e DB_PASSWORD=<DB_PASSWORD> -e DB_HOST=database shlinkio/shlink:stable 
